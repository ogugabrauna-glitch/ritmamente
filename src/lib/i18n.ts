...
const PT: Dict = {
  ...
  ranking: "Ranking",
  profile: "Perfil",
  hideHelper: "Ocultar Ritmizinho",
  showHelper: "Mostrar Ritmizinho",
  comment: "Comentar…",
  send: "Enviar",
  publish: "Publicar",
  ...
  welcomeMsg: "Olá! Eu sou o Ritmizinho e vou ajudar você a dominar o ritmo e a matemática!",
...
const EN: Dict = {
  ...
  ranking: "Ranking",
  profile: "Profile",
  hideHelper: "Hide Ritmizinho",
  showHelper: "Show Ritmizinho",
  comment: "Comment…",
  send: "Send",
  publish: "Publish",
  ...
  welcomeMsg: "Hello! I am Ritmizinho and I will help you master rhythm and math!",
...
const ES: Dict = {
  ...
  welcomeMsg: "¡Hola! Soy Ritmizinho y voy a ayudarte a dominar el ritmo y las matemáticas!",
